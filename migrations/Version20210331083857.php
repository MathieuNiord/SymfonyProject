 ...
 */
final class Version20210331083857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE im2021_utilisateurs ADD COLUMN paniers VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO im2021_utilisateurs (id, identifiant, mot_de_passe, nom, prenom, anniversaire, est_admin) SELECT id, identifiant, mot_de_passe, nom, prenom, anniversaire, est_admin FROM __temp__im2021_utilisateurs');
