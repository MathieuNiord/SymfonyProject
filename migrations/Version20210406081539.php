 ...
 */
final class Version20210406081539 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifiant VARCHAR(30) NOT NULL COLLATE BINARY --sert de login (doit être unique)
        ...
        $this->addSql('INSERT INTO im2021_utilisateurs (id, identifiant, motdepasse, nom, prenom, isadmin, anniversaire) SELECT pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM __temp__im2021_utilisateurs');
