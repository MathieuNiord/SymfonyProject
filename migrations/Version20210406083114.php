 ...
 */
final class Version20210406083114 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__im2021_utilisateurs AS SELECT id, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM im2021_utilisateurs');
        ...
        $this->addSql('INSERT INTO im2021_utilisateurs (pk, identifiant, motdepasse, nom, prenom, isadmin, anniversaire) SELECT id, identifiant, motdepasse, nom, prenom, isadmin, anniversaire FROM __temp__im2021_utilisateurs');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE im2021_utilisateurs');
        $this->addSql('CREATE TABLE im2021_utilisateurs --Table des utilisateurs du site
        (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifiant VARCHAR(30) NOT NULL --sert de login (doit être unique)
